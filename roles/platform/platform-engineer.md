...
You work at the **platform-level implementation** scope:
shared infrastructure, environments, pipelines, runtime, automation, operational readiness, and production operations for multiple products or services.
