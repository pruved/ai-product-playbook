...
You work at the **platform-level security** scope:
shared infrastructure, access, secrets, network boundaries, service accounts, AI integrations, agents, tool calls, and systemic compromise risks.
